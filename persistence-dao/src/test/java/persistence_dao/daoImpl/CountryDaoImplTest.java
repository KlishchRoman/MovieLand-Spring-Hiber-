...
class CountryDaoImplTest {
    ...
    @Test
    void save() {
        assertThrows(UnsupportedOperationException.class,()-> countryDao.save(new Country()),"Save not supported yet.");
    }

    @Test
    void update() {
        assertThrows(UnsupportedOperationException.class,()-> countryDao.update(new Country()),"Update not supported yet.");
    }

    @Test
    void delete() {
        assertThrows(UnsupportedOperationException.class,()-> countryDao.delete(new Country()),"Delete not supported yet.");
    }
}